...
# Last edited on 08/17/2015 by Allison Truhlar
...
# Remove line 15 (neither the max nor the min ch4 flux): 
# Date  Owner Gas Chamber Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/23 laurie CH4       3   Control       0.04390374           Day   0.01097593               25                NA
# Mean_vwc
#  14

ch4_data <- ch4_data[-15,]
ch4_flux <- ch4_data$flux_per_cap
ch4_treatment <- ch4_data$Treatment
ch4_temp <- ch4_data$Mean_temperature
ch4_cond <- ch4_data$Mean_conductivity
...
# Remove line 15 (neither the max nor the min ch4 flux): 
# Date  Owner Gas Chamber   Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/23 laurie CH4       4 Leach_field       -0.0466344           Day   -0.0116586         25.46667                NA
# Mean_vwc
# 14
...
ch4_model_3 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_3) 
...
# Remove line 15 (neither the max nor the min ch4 flux): 
# Date  Owner Gas Chamber   Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/23 laurie CH4       5 Leach_field       -0.0168667           Day -0.004216675         24.73333                NA
# Mean_vwc
# 23.33333
...
ch4_model_4 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_4) 
...
# Remove line 15 (neither the max nor the min ch4 flux): 
# Date  Owner Gas Chamber   Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/23 laurie CH4       6 Leach_field      -0.03817639           Day -0.009544099               25                NA
# Mean_vwc
# 18.66667
...
ch4_model_5 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_5) 
...
# Remove line 15 (neither the max nor the min ch4 flux): 
# Date  Owner Gas Chamber   Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/28 laurie CH4       1 Leach_field       -0.2174483           Day  -0.05436208             28.2        0.06333333
# Mean_vwc
# 13.33333
...
ch4_model_6 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_6) 
...
# Remove line 14 (neither the max nor the min ch4 flux):
# Date  Owner Gas Chamber Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/23 laurie CH4       2   Control      -0.06403534           Day  -0.01600883         24.93333                NA
# Mean_vwc
# 18.66667

ch4_data <- ch4_data[-14,]
ch4_flux <- ch4_data$flux_per_cap
ch4_treatment <- ch4_data$Treatment
ch4_temp <- ch4_data$Mean_temperature
ch4_cond <- ch4_data$Mean_conductivity
...
ch4_model_7 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_7) 
...
# Remove line 14 (neither the max nor the min ch4 flux):
# Date  Owner Gas Chamber   Treatment Mass_flux_linear Campaign_type flux_per_cap Mean_temperature Mean_conductivity
# 07/28 laurie CH4       2 Leach_field      0.005868127           Day  0.001467032         27.76667        0.09333333
# Mean_vwc
# 13.33333
...
ch4_model_8 <- lmer(ch4_flux ~ ch4_treatment + ch4_temp + ch4_cond + ch4_vwc + ch4_treatment:ch4_temp + ch4_treatment:ch4_cond + ch4_treatment:ch4_vwc + ch4_temp:ch4_cond + ch4_temp:ch4_vwc + ch4_cond:ch4_vwc +(1|ch4_site))
summary(ch4_model_8) 
...
# Would need to remove line 14.  This is going on forever.  I'm going to make a new version (v3) that tries converting 
# ch4_flux with a log transformation
